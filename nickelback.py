# -------------------------------------------------
# n this exercises, you're going to use a conditional statement 
# inside a comprehension. Let's look at a basic example.
...
# list = [] has order 
# set = {} isn't ordered with unqiue values

songs = {('Nickelback', 'How You Remind Me'), ('Will.i.am', 'That Power'), ('Miles Davis', 'Stella by Starlight'), ('Nickelback', 'Animals')}

not_nickelback = {song for song in songs if song[0] != 'Nickelback'}
print(not_nickelback)

 
# better_songs = [song for song in songs if len(song) == 10]
# print(better_songs)
